...
#define MODULE_NAME "VideoCore"
#define LOCTEXT_NAMESPACE "FVideoCoreModule"

void FVideoCoreModule::StartupModule()
{
...
void FVideoCoreModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FVideoCoreModule, VideoCore)
