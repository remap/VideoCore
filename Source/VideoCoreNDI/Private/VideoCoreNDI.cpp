...
#define MODULE_NAME "VideoCoreNDI"
#define LOCTEXT_NAMESPACE "FVideoCoreNdiModule"

void FVideoCoreNdiModule::StartupModule()
{
...
void FVideoCoreNdiModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FVideoCoreNdiModule, VideoCoreNDI)
